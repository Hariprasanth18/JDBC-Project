...
public class CustomerViewDetails extends JFrame 
{
	...
	public static void main(String[] args) 
	{
		EventQueue.invokeLater(new Runnable() 
		{
			public void run() 
			{
				try
				{
					CustomerViewDetails frame = new CustomerViewDetails();
	...
	public CustomerViewDetails() 
	{
		...
		btnViewdata.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				...
				String str="select * from addcustomer where customer_id='"+id+"'";
		...
		//Important code for view tables
				...
				btnViewall.setBounds(250, 55, 90, 25);
