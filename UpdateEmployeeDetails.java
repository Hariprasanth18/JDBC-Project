...
public class UpdateEmployeeDetails extends JFrame 
{
	...
	public UpdateEmployeeDetails() 
	{
		...
		JLabel lblUpdateCustomerDetails = new JLabel("UPDATE EMPLOYEE DETAILS");
		...
		btnUpdate.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					...
					String ea=textArea.getText();
					String ep=textField_2.getText();
					
					String query="update addemployee set employee_name='"+en+"', address='"+ea+"', phone_no='"+ep+"'  where employee_id='"+id+"'";
		...
		btnUpdate.setBounds(242, 358, 95, 30);
		...
		btnView.setBounds(111, 358, 95, 30);
		...
		btnBack.setBounds(51, 399, 95, 30);
		...
		btnHome.setBounds(290, 399, 95, 30);
